...
/* =====================
   MAIN INTENT CLASSIFICATION (New Flow)
   ===================== */
...
- "FOOD_QUESTION" - general food/dining questions (e.g. "how to tip", "why didn't you suggest...")
- "FOLLOWUP" - providing more info for a previous search (e.g. "what about Brooklyn?", "cheap ones")
...
{
  "type": "EVENT" or "RESTAURANT" or "FOOD_QUESTION" or "FOLLOWUP" or "OTHER",
  "detectedFilters": {
